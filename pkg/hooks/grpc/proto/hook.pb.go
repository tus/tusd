...
type FileInfo struct {
	...
	// ExpiresAt is the time after which the upload is considered expired. It is not
	// set if the upload does not expire. Expiration is only enforced as long as an
	// upload is not finished yet, with partial uploads from the concatenation
	// extension being an exception.
...
type FileInfoChanges struct {
	...
	// If ExpiresAt is set, it replaces the expiration time of the upload, which is derived
	// from the server-wide expiration duration by default. Set it to the zero timestamp to
	// prevent the upload from expiring at all. A time in the past is rejected, since the
	// upload would not be usable after its creation.
...
func (x *FileInfoChanges) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
var file_pkg_hooks_grpc_proto_hook_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x45, 0x0a, 0x0b, 0x48, 0x6f, 0x6f,
	0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x22, 0x0a, 0x05,
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74,
	0x22, 0x66, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x27, 0x0a, 0x06, 0x75, 0x70, 0x6c,
	...
	0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xf4, 0x03, 0x0a, 0x08, 0x46, 0x69, 0x6c,
	...
	,
	...
	,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xcb, 0x01, 0x0a, 0x0c, 0x48, 0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x73,
	...
	0x61, 0x64, 0x22, 0xb6, 0x01, 0x0a, 0x0c, 0x48, 0x54, 0x54, 0x50, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x6f, 0x64, 0x65, 0x12, 0x37, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x48, 0x54, 0x54, 0x50,
	...
	,
...
var file_pkg_hooks_grpc_proto_hook_proto_depIdxs = []int32{
	...
	13, // 5: proto.FileInfo.expiresAt:type_name -> google.protobuf.Timestamp
	9,  // 6: proto.FileInfoChanges.metaData:type_name -> proto.FileInfoChanges.MetaDataEntry
	10, // 7: proto.FileInfoChanges.storage:type_name -> proto.FileInfoChanges.StorageEntry
	13, // 8: proto.FileInfoChanges.expiresAt:type_name -> google.protobuf.Timestamp
	11, // 9: proto.HTTPRequest.header:type_name -> proto.HTTPRequest.HeaderEntry
	...
	12, // 12: proto.HTTPResponse.header:type_name -> proto.HTTPResponse.HeaderEntry

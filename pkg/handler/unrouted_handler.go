	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if origin := r.Header.Get("Origin"); origin != "" {
			...
			if r.Method == "OPTIONS" {
				...
				header.Add("Access-Control-Allow-Headers", "Authorization, Origin, X-Requested-With, X-HTTP-Method-Override, Content-Type, Upload-Length, Upload-Offset, Tus-Resumable, Upload-Metadata, Upload-Defer-Length, Upload-Concat")

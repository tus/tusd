...
func ParseFlags() {
	...
	flag.StringVar(&Flags.AzureStorage, "azure-storage", "", "Use Azure Blob Storage with this container name as a storage backend (requires the AZURE_ACCOUNT_NAME and AZURE_ACCOUNT_KEY environment variable to be set)")
	flag.StringVar(&Flags.AzureObjectPrefix, "azure-object-prefix", "", "Prefix for Azure object names")
	flag.StringVar(&Flags.AzureEndpoint, "azure-endpoint", "", "Custom Endpoint to use for Azure Blob Storage (requires azure-storage to be pass)")
